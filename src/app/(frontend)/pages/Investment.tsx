          ...
          <div className="flex flex-col gap-4 items-start min-w-0 w-full xl:flex-[760_1_0]">
            ...
            <div className="text-base md:text-lg xl:text-xl text-base-content/80 md:max-w-[760px] space-y-5 md:space-y-6 mt-2 text-left">
              <p>
                ...
                invest heavily in ETFs, blockchain technology, and forward-looking assets, treating
                my portfolio as a system to be optimized. Staying on top of market trends is my
                favorite intellectual challenge outside of tech, ensuring my capital is always
                working efficiently.
              </p>
              <p>
